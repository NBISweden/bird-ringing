...
const actorForm = {
  ...
  actorFormBirthYearPlaceholder: "Skriv ett födelseår",
  ...
  actorFormCreationYearPlaceholder: "Skriv ett startår",
...
export const locale: TranslationMap = {
  ...
  permissionTypeAddTitle: "Lägg till tillståndstyp",
  permissionTypeEditTitle: "Redigera tillståndstyp",
  permissionPropertyAddButton: "Lägg till egenskap",
  permissionPropertyAddGlobalButton: "Lägg till global egenskap",
  permissionPropertyAddGlobalTitle: "Lägg till global tillståndsegenskap",
  permissionPropertyEditTitle: "Redigera egenskap",
  permissionPropertyAddToTypeTitle: 'Lägg till egenskap till "{label}"',
  permissionTypeAddedMessage: "Tillståndstypen har lagts till.",
  permissionTypeUpdatedMessage: "Tillståndstypen har uppdaterats.",
  permissionPropertyAddedMessage: "Egenskapen har lagts till.",
  permissionPropertyUpdatedMessage: "Egenskapen har uppdaterats.",
  permissionFormNameLabel: "Namn",
  permissionFormNamePlaceholder: "Ange ett namn",
  permissionFormDescriptionLabel: "Beskrivning",
  permissionFormDescriptionPlaceholder: "Ange en beskrivning",
  permissionFormSave: "Spara",
  permissionFormAdd: "Lägg till",
  permissionTypesEmpty: "Inga tillståndstyper ännu.",
  permissionPropertiesGlobalEmpty: "Inga globala egenskaper ännu.",
