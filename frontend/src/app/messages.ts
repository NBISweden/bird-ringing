...
const licenseForm = {
  ...
  licenseFormAddTitle: "New license",
...
const messagesBase = {
  ...
  permissionTypeAddTitle: "Add permission type",
  permissionTypeEditTitle: "Edit permission type",
  permissionPropertyAddButton: "Add property",
  permissionPropertyAddGlobalButton: "Add global property",
  permissionPropertyAddGlobalTitle: "Add global permission property",
  permissionPropertyEditTitle: "Edit property",
  permissionPropertyAddToTypeTitle: 'Add property to "{label}"',
  permissionTypeAddedMessage: "Permission type added.",
  permissionTypeUpdatedMessage: "Permission type updated.",
  permissionPropertyAddedMessage: "Property added.",
  permissionPropertyUpdatedMessage: "Property updated.",
  permissionFormNameLabel: "Name",
  permissionFormNamePlaceholder: "Add a name",
  permissionFormDescriptionLabel: "Description",
  permissionFormDescriptionPlaceholder: "Add a description",
  permissionFormSave: "Save",
  permissionFormAdd: "Add",
  permissionTypesEmpty: "No permission types yet.",
  permissionPropertiesGlobalEmpty: "No global properties yet.",
