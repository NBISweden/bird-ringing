from licensing.models import LicenseSequence, License, Actor, ActorTypeChoices, SexChoices, LanguageChoices
...
class LicenseSerializer(serializers.ModelSerializer):
    class Meta:
        model = License
        fields = ["version", "location", "description", "report_status"]
